...
class NoteGenerator(object):
    def __init__(self, pitch, gain, timbre="sine"):
        ...
        harmonics = {
            "sine": (np.sin, (1.0,)),
            "square": (np.sin, (1.0, 0, 1 / 3.0, 0, 1 / 5.0, 0, 1 / 7.0, 0, 1 / 9.0)),
            "sawtooth": (
                np.sin,
                (
                    1.0,
            ...
            "triangle": (np.cos, (1.0, 0, 1 / 9.0, 0, 1 / 25.0, 0, 1 / 49.0)),
        }
...
class Envelope(object):
    ...
    def generate(self, num_frames, num_channels):
        ...
        # decay part:
        env2 = 1.0 - ((frames[boundary:] - self.attack_frames) / self.decay_frames) ** (
            1.0 / self.n2
        )
